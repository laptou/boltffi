...
pub fn rust_future_invalid_arg<T: RustFutureOutput>() -> RustFutureHandle {
...
pub unsafe fn rust_future_complete<T: RustFutureOutput>(handle: RustFutureHandle) -> Result<T, FfiStatus> {
